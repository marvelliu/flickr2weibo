...
class OAuthHandler(AuthHandler):
    ...
    def _get_request_token(self):
        ...
        #print self._consumer.key
        #print self._consumer.secret
        request.sign_request(self._sigmethod, self._consumer, None)
        #resp = urlfetch.fetch(Request(url, headers=request.to_header()))
        resp = urlfetch.fetch(url, headers = request.to_header(), method = 'POST')   
        #print resp.content
